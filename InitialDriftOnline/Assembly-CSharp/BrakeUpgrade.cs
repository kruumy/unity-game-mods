...
public class BrakeUpgrade : MonoBehaviour
{
	public int Stage0;
	...
	public void UpdateHightLightbtn()
	{
		...
		if (PlayerPrefs.GetString("BreakBtnUsed" + text) == "Stage (0)")
		{
			HighLightThis(S0);
		}
	...
	public void HighLightThis(GameObject target)
	{
		...
		PlayerPrefs.SetString("BreakBtnUsed" + text, target.transform.name);
	}

	public void BreakStage0()
	{
		Debug.Log("STAGE 0");
		RCC_Customization.SetMaximumBrake(RCC_SceneManager.Instance.activePlayerVehicle, Stage0);
		RCC_Customization.SaveStatsTemp(RCC_SceneManager.Instance.activePlayerVehicle);
	}

	public void BreakStage1()
	{
		Debug.Log("STAGE 1");
		RCC_Customization.SetMaximumBrake(RCC_SceneManager.Instance.activePlayerVehicle, Stage1);
		RCC_Customization.SaveStatsTemp(RCC_SceneManager.Instance.activePlayerVehicle);
	}

	public void BreakStage2()
	{
		Debug.Log("STAGE 2");
		RCC_Customization.SetMaximumBrake(RCC_SceneManager.Instance.activePlayerVehicle, Stage2);
		RCC_Customization.SaveStatsTemp(RCC_SceneManager.Instance.activePlayerVehicle);
	}

	public void BreakStage3()
	{
		Debug.Log("STAGE 3");
		RCC_Customization.SetMaximumBrake(RCC_SceneManager.Instance.activePlayerVehicle, Stage3);
		RCC_Customization.SaveStatsTemp(RCC_SceneManager.Instance.activePlayerVehicle);
	}

	public void BreakStage4()
	{
		Debug.Log("STAGE 4");
		RCC_Customization.SetMaximumBrake(RCC_SceneManager.Instance.activePlayerVehicle, Stage4);
		RCC_Customization.SaveStatsTemp(RCC_SceneManager.Instance.activePlayerVehicle);
	}

	public void BreakStage5()
	{
		Debug.Log("STAGE 5");
		RCC_Customization.SetMaximumBrake(RCC_SceneManager.Instance.activePlayerVehicle, Stage5);
		RCC_Customization.SaveStatsTemp(RCC_SceneManager.Instance.activePlayerVehicle);
	}
}
